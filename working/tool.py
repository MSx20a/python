...
def loginBackStage(num: str, group: str, userName: str, passWord: str):
    ...
    if num == 1:  # Firefox
        ...
        driver.maximize_window()
        driver.get("https://auth.third.mymine.one/Account/Login?ReturnUrl=%2Fconnect%2Fauthorize%3Fresponse_type%3Dcode%26client_id%3DThird_Angular%26state%3DMnNQQlBSampwa0l4M1NqSTl-MEUxUUJ2eUhCYjlDd21lTkNtUVgxU01DVWd2%26redirect_uri%3Dhttps%253A%252F%252Fapp.third.mymine.one%26scope%3Doffline_access%2520openid%2520profile%2520email%2520phone%2520AccountService%2520IdentityService%2520AdministrationService%2520SaasService%2520ProductService%2520BankerService%2520PaymentService%2520OrderingService%26code_challenge%3DGdad9Nstl-HgpWHeYg65ystrozakGfbgR5n8yaguSmo%26code_challenge_method%3DS256%26nonce%3DMnNQQlBSampwa0l4M1NqSTl-MEUxUUJ2eUhCYjlDd21lTkNtUVgxU01DVWd2%26culture%3Dzh-Hant%26ui-culture%3Dzh-Hant")
    elif num == 2:  # Chrome
        chrome_options = webdriver.ChromeOptions()
        chrome_options.add_experimental_option("detach", True)
        driver = webdriver.Chrome(options=chrome_options)
